...
DEBANK_SYMBOL_2_COINGECKO_MAPPING = {
    ...
    "PT-GLP-28MAR2024": ["ethereum", "usd-coin"],
    "PT-gDAI-28MAR2024": ["dai"],
    "frxETH": ["ethereum"],
    "PT-sfrxETH-26DEC2024": ["wrapped-steth"],
    "PT-rETH-WETH_BalancerLP Aura-26DEC2024": ["wrapped-steth"],
    "BTCB": ["bitcoin"],
    "BUSD": ["binance-usd"],
    "PENDLE": ["pendle"],
    "wstETH": ["wrapped-steth"],
    "ARB": ["arbitrum"],
    "PT-PENDLE-ETH_Camelot-27JUN2024": ["pendle", "ethereum"],
    "PT-Thena frxETH-ETH-27JUN2024": ["ethereum"],
    "USDt": ["tether"],
    "ePendle": ["pendle"],
    "VARA": ["equilibre"],
    "rETH": ["wrapped-steth"],
    "PT-HLP-27JUN2024": ["ethereum", "usd-coin"],
    "OETH": ["wrapped-steth"],
